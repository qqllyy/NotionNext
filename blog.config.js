...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://necessary-pumpkin-e84.notion.site/2a04bd28f2d7414a808f43a2c3fd0724?v=8439298165694ec2bcbb72f6e55817d1&pvs=4
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '8439298165694ec2bcbb72f6e55817d1&pvs=4',
  PSEUDO_STATIC: true, // 伪静态路径，开启后所有文章URL都以 .html 结尾。
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 5, // 更新内容缓存间隔 5单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://boke.qqllyy.cloudns.org/', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '©♥钰郎哥ᯤ¹🐬', // 备案号 闽ICP备XXXXXXX
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    },
    {
      name: '向云端（女）',
      artist: 'Falcom Sound Team jdk',
      url: 'https://photo.yiji007.com/2023/6/21/files/44437724_1687360956244.mp3',
      cover:
          'https://photo.yiji007.com/2023/6/21/images/44437724_1687360200491.jpg'
    },
    {
  ...
  MUSIC_PLAYER_METING_ID:
      process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '7795919291', // 对应歌单的 id
  ...
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || '钰郎哥ᯤ¹🐬', // 站点描述，被notion中的页面描述覆盖
